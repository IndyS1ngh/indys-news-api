...
exports.selectArticleById = (article_id) => {
  return db
    .query(`SELECT articles.*, (COUNT(comments.article_id) :: INTEGER) AS comment_count FROM comments RIGHT JOIN articles ON articles.article_id = comments.article_id WHERE articles.article_id = $1 GROUP BY articles.article_id;`, [article_id])
    .then(({ rows }) => {
      if (!rows.length) {
